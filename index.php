        ...
        <div class="row">
          <div class="col-lg-7 mx-auto order-lg-2 align-self-center">
            <div class="site-block-cover-content text-center">
              <h2 class="sub class"  style="font : serif" style ="color : black">Effective Medicine, New Medicine Everyday</h2>
              <h1 style ="color : BLACK" >Welcome To Pharma</h1>
              <p>
              ...
              <div class="testimony">
                <blockquote>
                  ...
                  <p>&ldquo;I would like to thanks Pharma for their brilliant Customer Service. I ordered
                    ...
                    good work. Pharma is the best medicine website. I recommend everyone to use Pharma
                    Website.&rdquo;</p>
                </blockquote>
