    ...
    <div id="signupbox" style=" margin-top:50px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
        ...
        <div class="panel panel-info">
            <div class="panel-heading">
                <div class="panel-title">Sign Up for supplier</div>
            </div>
            <?php
            ...
            <div class="panel-body">
                <form id="signupform" class="form-horizontal" role="form" method="post" action="signUps.php">
                    ...
                    <div class="form-group">
                        <label for="address" class="col-md-3 control-label">place</label>
                        <div class="col-md-9">
