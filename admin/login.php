            ...
            <div style="padding-top:30px" class="panel-body">
                ...
                <form id="loginform" class="form-horizontal" role="form" method="post" action="login.php">
                    ...
                    <div style="margin-bottom: 25px" class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-admin"></i></span>
                        <input id="login-adminname" type="text" class="form-control" name="adminEmail" value="" placeholder="email">
                    </div>
