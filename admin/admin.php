            ...
            <div class="row align-items-start">
                ...
                <div class="col">
                    ...
                    <form class="d-flex" method="GET" action="admin.php">
                        <input class="form-control me-2 col" type="search" name="search_admin_fname" placeholder="Search for admin (fname)" aria-label="Search">
                        <button class="btn btn-outline-secondary" type="submit" name="search_fname" value="search">Search</button>
                    </form>
                    <br>
                </div>
            </div>
