            ...
            <div class="row align-items-start">
                ...
                <div class="col">
                    ...
                    <form class="d-flex" method="GET" action="customers.php">
                        <input class="form-control me-2 col" type="search" name="search_user_fname" placeholder="Search for user (fname)" aria-label="Search">
        ...
        ?>
            ...
            <form action="customers.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input pattern="{1,15}" type="text" class="form-control" placeholder="<?php echo $data[0]['user_phn'] ?>" name="phn">
                    <div class="form-text">please enter the first name in range(1-30) character/s , special character & numbers not allowed !</div>
                </div>
                <br>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label>State</label>
                    <input pattern="[A-Za-z_]" type="text" class="form-control" placeholder="<?php echo $data[0]['user_state'] ?>" name="state">
                    <div class="form-text">please enter the first name in range(1-30) character/s , special character & numbers not allowed !</div>
                </div>
                <br>
                ...
                <div class="form-group">
                    <label>Pincode</label>
                    <input pattern="{1,15}" type="text" class="form-control" placeholder="<?php echo $data[0]['user_pincode'] ?>" name="pincode">
                    <div class="form-text">please enter the first name in range(1-30) character/s , special character & numbers not allowed !</div>
                </div>
                <br>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $data[$i]['user_phn'] ?></td>
                            <td><?php echo $data[$i]['user_address'] ?></td>
                            <td><?php echo $data[$i]['user_state'] ?></td>
                            <td><?php echo $data[$i]['user_pincode'] ?></td>
                            <!--td>
