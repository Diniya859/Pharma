...
<?php
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <?php
        edit_item(isset($_SESSION['item_id']));
        if (isset($_GET['edit'])) {
            $_SESSION['item_id'] = $_GET['edit'];
            $data = get_item($_SESSION['item_id']);
        ...
        ?>
            ...
            <form action="products.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="date"  class="form-control" placeholder="<?php echo $data[0]['item_expiry'] ?>" name="expiry">
